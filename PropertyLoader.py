...
class PropertyLoader:
    ...
    def read_config_properties(self):
        ...
        self.src_db_home = config.get(SOURCE_DB_SECTION, 'src_db_home')
        # TARGET_DB
        ...
        self.tgt_dms_endpoint_engine = self.tgt_rds_db_engine.split('-')[0]  # sqlserver-ex to sqlserver. Not all database types need this
        self.tgt_rds_db_username = config.get(TARGET_DB_RDS_SECTION, 'tgt_rds_db_username')
        self.tgt_rds_db_secret = config.get(TARGET_DB_RDS_SECTION, 'tgt_rds_db_secret')
